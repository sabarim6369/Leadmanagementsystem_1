...
const Callssummary = ({stats}) => {
  return (
    <div> <div className="w-full bg-gray-700 pt-5 mt-5 rounded-2xl p-4 md:p-8">
    <h3 className="text-white text-xl font-bold">Today's Calls</h3>
    <h4 className="text-white mt-2">Call summary</h4>
...
/>
        ...
        <div className="ml-6 mt-7 space-y-2">
          <div className="text-white font-bold text-2xl">{stats.totalCalls}</div>
          <div className="text-white font-bold">Total calls</div>
          <div className="text-yellow-600">+10% from yesterday</div>
        </div>
      </div>
      <div className="rounded-2xl p-4 bg-black">
        <div className="mt-5 ml-6"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M21.6485 16.3664L18.255 15.9789C17.44 15.8854 16.6384 16.166 16.0639 16.7405L13.6056 19.1987C9.82467 17.2749 6.7251 14.1886 4.80123 10.3943L7.27287 7.92266C7.84736 7.34816 8.12792 6.54655 8.0344 5.73157L7.64696 2.36477C7.48663 1.01538 6.35101 0 4.98827 0H2.67695C1.16725 0 -0.0886137 1.25587 0.00490785 2.76558C0.713 14.1753 9.83803 23.287 21.2343 23.9951C22.744 24.0886 23.9999 22.8327 23.9999 21.323V19.0117C24.0132 17.6623 22.9979 16.5267 21.6485 16.3664Z" fill="#A9DFD8"/>
        ...
        <div className="ml-6 mt-7 space-y-2">
        <div className="text-white font-bold  text-2xl">{stats.answeredCalls}</div>
<div className="text-white font-bold">Answered</div>
<div className="text-blue-200 ">+8% from yesterday</div>
        </div>
      </div>
      <div className="rounded-2xl p-4 bg-black">
        <div className="mt-5 ml-6"><svg width="55" height="40" viewBox="0 0 35 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
/>
        ...
        <div className="text-white font-bold  text-2xl">{stats.confirmed}</div>
